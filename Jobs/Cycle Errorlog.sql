...
/****** Object:  Job [DBA Cycle Errorlog]    Script Date: 30-9-2020 18:30:27 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 30-9-2020 18:30:27 ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Adaptive Cycle Errorlog]    Script Date: 30-9-2020 18:30:27 ******/
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Daily Cycle Errorlog', 
		...
		@schedule_uid=N'1f6d4281-d4b7-4997-b6d0-b9bc5e7c2802'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
