...
IF NOT EXISTS (
    ...
    WHERE name = N'Database administration'
...
EXEC @ReturnCode = msdb.dbo.sp_add_job @job_name = N'DBA - BlitzFirst',
                                       @enabled = 1,
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id = @jobId,
                                           @step_name = N'Collect sp_BlitzFirst results',
                                           @step_id = 1,
...
DECLARE @jobId BINARY(16);
EXEC @ReturnCode = msdb.dbo.sp_add_job @job_name = N'DBA - BlitzIndex',
                                       @enabled = 1,
                                       @notify_level_eventlog = 0,
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id = @jobId,
                                           ...
                                           @os_run_priority = 0,
                                           @subsystem = N'TSQL',
                                           @command = N'EXEC master.dbo.sp_BlitzIndex @DatabaseName = N''HiX_Acc'',
                              @OutputDatabaseName = ''DBA'',
                              @OutputSchemaName = ''dbo'',
                              @OutputTableName = ''BlitzIndex_UsageStats'',
                              @Mode = 2;',
                                           @database_name = N'master',
                                           @flags = 0;
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id = @jobId,
                              ...
                              @OutputTableName = N''BlitzIndex_MissingIndexes'',
                              @Mode = 3;',
                                           @database_name = N'master',
                                           @flags = 0;
...
DECLARE @jobId BINARY(16);
EXEC @ReturnCode = msdb.dbo.sp_add_job @job_name = N'DBA - BlitzWho',
                                       @enabled = 1,
                                       @notify_level_eventlog = 0,
                                       @notify_level_email = 2,
                                       @notify_level_netsend = 0,
