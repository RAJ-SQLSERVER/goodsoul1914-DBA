...
CREATE PROCEDURE dbo.usp_VLFInfo
AS
BEGIN
    ...
    BEGIN
        ...
        FETCH NEXT FROM DatabaseIteration
        INTO @dbName;
        ...
        BEGIN
            ...
            ELSE
            BEGIN
                INSERT INTO @DbccLogInfo (RecoveryUnitId,
                                          fileid,
                                          file_size,
                                          start_offset,
                                          fseqno,
    ...
    SELECT CTE_VLF.*,
           CASE
               WHEN VLFCount >= 1000 THEN 'Check your VLF count, maybe you need reduce it'
