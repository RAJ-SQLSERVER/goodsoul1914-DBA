...
/****** Object:  Job [DBA - Performance Counter Snapshot]    Script Date: 14-9-2021 08:43:48 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 14-9-2021 08:43:48 ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Performance Counter Snapshot]    Script Date: 14-9-2021 08:43:49 ******/
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Every 5 minutes', 
		...
		@schedule_uid=N'173e1c5b-a01d-4a03-adc4-63073f86b180'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
