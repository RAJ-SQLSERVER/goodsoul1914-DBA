...
GO
ALTER TABLE [dbo].[Databases] ADD  CONSTRAINT [DF_Databases_CheckDate]  DEFAULT (getdate()) FOR [CheckDate]
GO
ALTER TABLE [dbo].[DatabaseUsers] ADD  CONSTRAINT [DF_DatabaseUsers_CheckDate]  DEFAULT (getdate()) FOR [CheckDate]
GO
	...
	SET @body
        = N'<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
			<html>
				...
				<body>  
					<p>(This mail was sent by the procedure ''' + DB_NAME () + N'.' + OBJECT_SCHEMA_NAME (@@PROCID)
          + N'.' + OBJECT_NAME (@@PROCID)
          + N''')</p>               
	...
	SET @body
        = N'<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
			<html>
				...
				<body>  
					<p>(This mail was sent by the procedure ''' + DB_NAME () + N'.' + OBJECT_SCHEMA_NAME (@@PROCID) + N'.'
					  + OBJECT_NAME (@@PROCID)
					  + N''')</p>               
