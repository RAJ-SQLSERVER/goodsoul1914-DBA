...
IF EXISTS (SELECT name FROM sys.objects WHERE name = 'CheckDBSnapshotDirCreate' AND SCHEMA_Name(schema_id) = 'Minion')
BEGIN
DROP PROCEDURE Minion.CheckDBSnapshotDirCreate
END
GO
