...
IF EXISTS (SELECT name FROM sys.objects WHERE name = 'DBMaintStatusMonitorONOff' AND SCHEMA_Name(schema_id) = 'Minion')
BEGIN
DROP PROCEDURE Minion.DBMaintStatusMonitorONOff
END
GO
