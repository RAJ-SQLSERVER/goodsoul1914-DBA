...
--This script's time zone conversion feature will only work SQL 2016+
--See also: toolbox\AG - Health_XEvents pre-2016.sql for a version that displays this data in UTC.
...
SELECT CurrentTime_Local = SYSDATETIMEOFFSET()
