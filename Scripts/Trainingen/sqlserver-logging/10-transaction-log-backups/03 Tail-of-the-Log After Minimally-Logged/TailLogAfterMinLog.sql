...
TO  DISK = 'D:\SQLBackups\DBMaint2012_Log1.bck'
WITH INIT;
GO
...
-- The backup doesn't have the most recent transactions - if we restore it we'll lose them.
...
FROM DISK = 'D:\SQLBackups\DBMaint2012_Log1.bck'
WITH REPLACE,
     NORECOVERY;
GO

RESTORE LOG DBMaint2012
FROM DISK = 'D:\SQLBackups\DBMaint2012_tail.bck'
WITH REPLACE;
GO
