...
BACKUP DATABASE [DBMaint2012] TO
	DISK = 'D:\Pluralsight\DBMaint2012_Full_0.bak'
	WITH INIT, STATS;
GO

BACKUP LOG [DBMaint2012] TO
	DISK = 'D:\Pluralsight\DBMaint2012_Log_0_Initial.bak'
	WITH INIT, STATS;
GO
...
BACKUP LOG [DBMaint2012] TO
	DISK = 'D:\Pluralsight\DBMaint2012_Log_1_Baseline.bak'
	WITH INIT, STATS;
GO
...
-- the log
BACKUP DATABASE [DBMaint2012] TO
	DISK = 'D:\Pluralsight\DBMaint2012_Full_1.bak'
	WITH INIT, STATS;
GO
...
-- very small
BACKUP LOG [DBMaint2012] TO
	DISK = 'D:\Pluralsight\DBMaint2012_Log_2_FullTest.bak'
	WITH INIT, STATS;
GO
...
-- very small
BACKUP LOG [DBMaint2012] TO
	DISK = 'D:\Pluralsight\DBMaint2012_Log_3_CheckTest.bak'
	WITH INIT, STATS;
GO
...
BACKUP LOG [DBMaint2012] TO
	DISK = 'D:\Pluralsight\DBMaint2012_Log_4_LongTest.bak'
	WITH INIT, STATS;
GO
...
BACKUP DATABASE [DBMaint2012] TO
	DISK = 'D:\Pluralsight\DBMaint2012_Full_2.bak'
	WITH INIT, STATS;
GO
DBCC SQLPERF (LOGSPACE);
GO
...
BACKUP LOG [DBMaint2012] TO
	DISK = 'D:\Pluralsight\DBMaint2012_Log_5_LongTest2.bak'
	WITH INIT, STATS;
GO
DBCC SQLPERF (LOGSPACE);
GO
