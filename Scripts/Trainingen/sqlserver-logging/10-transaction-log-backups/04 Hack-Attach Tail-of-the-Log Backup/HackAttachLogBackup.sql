...
BEGIN
    ALTER DATABASE DBMaint2008 SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
...
FROM DISK = N'D:\SQLBackups\DBMaint2008_Full_HAD.bck'
WITH REPLACE,
     NORECOVERY,
     MOVE N'DBMaint2008'
     TO N'D:\SQLData\DBMaint2008.mdf',
     MOVE N'DBMaint2008_log'
     TO N'D:\SQLLogs\DBMaint2008.ldf';
GO

-- And all other backups...
RESTORE LOG DBMaint2008
FROM DISK = N'D:\SQLBackups\DBMaint2008_Log1_HAD.bck'
WITH NORECOVERY;
GO
...
-- Check the data
SELECT *
FROM DBMaint2008.dbo.TestTable;
GO
...
-- Delete the files and copy in the log file from D:\Pluralsight
...
-- Take a log backup?
BACKUP LOG DBMaint2008
TO  DISK = N'D:\SQLBackups\DBMaint2008_tail.bck'
WITH INIT;
GO
...
-- And restore the tail of the log backup we just took
RESTORE LOG DBMaint2008
FROM DISK = N'D:\SQLBackups\DBMaint2008_tail.bck'
WITH NORECOVERY;
GO
