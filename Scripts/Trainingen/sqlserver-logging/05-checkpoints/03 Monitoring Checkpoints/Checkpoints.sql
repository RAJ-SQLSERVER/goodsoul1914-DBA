...
BEGIN
    ALTER DATABASE CheckpointTest SET SINGLE_USER WITH ROLLBACK IMMEDIATE;
...
ON PRIMARY (
       ...
       FILENAME = N'D:\SQLData\CheckpointTest_data.mdf'
   )
LOG ON (
    NAME = N'CheckpointTest_log',
    FILENAME = N'D:\SQLLogs\CheckpointTest_log.ldf',
    SIZE = 250MB,
    FILEGROWTH = 20MB
);
GO
