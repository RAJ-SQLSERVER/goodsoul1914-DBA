...
BACKUP LOG Company
TO  DISK = N'D:\SQLBackups\Company_Log_Monday.bak'
WITH INIT,
     NAME = N'Company Log Monday 1';
GO

BACKUP DATABASE Company
TO  DISK = N'D:\SQLBackups\Company_Diff_Monday.bak'
WITH INIT,
     DIFFERENTIAL,
...
BACKUP LOG Company
TO  DISK = N'D:\SQLBackups\Company_Log_Tuesday.bak'
WITH INIT,
...
RESTORE DATABASE Company
FROM DISK = N'D:\SQLBackups\Company_Diff_Monday.bak'
WITH FILE = 5,
     NORECOVERY;

-- And finally all the log backups after that
RESTORE DATABASE Company
FROM DISK = N'D:\SQLBackups\Company_Log_Tuesday.bak'
WITH FILE = 1,
     NORECOVERY;
GO
...
RESTORE DATABASE Company
FROM DISK = N'D:\SQLBackups\Company_Log_Monday.bak'
WITH FILE = 19,
     NORECOVERY;
GO
...
RESTORE HEADERONLY FROM DISK = N'D:\SQLBackups\Company_Log_Monday.bak';
