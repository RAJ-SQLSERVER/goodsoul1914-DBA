...
TO  DISK = N'D:\SQLBackups\CompanyFullNoChecksum.bak'
WITH INIT,
     NAME = N'Company Full';
GO
...
BACKUP DATABASE Company
TO  DISK = N'D:\SQLBackups\CompanyFullChecksum.bak'
WITH INIT,
...
RESTORE VERIFYONLY FROM DISK = N'D:\SQLBackups\CompanyFullNoChecksum.bak';
GO

-- And the forced backup...
RESTORE VERIFYONLY FROM DISK = N'D:\SQLBackups\CompanyFullChecksum.bak';
GO

-- What about using WITH CHECKSUM?
RESTORE VERIFYONLY
FROM DISK = N'D:\SQLBackups\CompanyFullChecksum.bak'
WITH CHECKSUM;
GO
...
RESTORE VERIFYONLY
FROM DISK = N'D:\SQLBackups\CompanyFullNoChecksum.bak'
WITH CHECKSUM;
GO
