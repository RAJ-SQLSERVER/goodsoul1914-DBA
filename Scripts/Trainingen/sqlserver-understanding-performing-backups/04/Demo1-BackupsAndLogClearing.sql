-- Demo script for Backups and Log Clearing demo
...
-- Perform a log backup
BACKUP LOG [Company]
TO DISK = N'D:\Pluralsight\Company_Log3.bak'
WITH
	INIT,
...
-- Perform a log backup
BACKUP LOG [Company]
TO DISK = N'D:\Pluralsight\Company_Log4.bak'
WITH
	INIT,
...
-- Perform a log backup
BACKUP LOG [Company]
TO DISK = N'D:\Pluralsight\Company_Log5.bak'
WITH
	INIT,
...
-- Perform a log backup
BACKUP LOG [Company]
TO DISK = N'D:\Pluralsight\Company_Log6.bak'
WITH
	INIT,
