...
-- Now set up the demo again by running the code in the C:\Temp\SetupWorkload.sql file
...
-- I could write code to view the Events, but using SQL Server 2012 SSMS is much better in this case
