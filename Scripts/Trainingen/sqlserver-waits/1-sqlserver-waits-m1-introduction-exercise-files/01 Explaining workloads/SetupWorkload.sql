...
ON PRIMARY (NAME = N'HotSpot_data', FILENAME = N'D:\SQLData\HotSpot_data.mdf')
LOG ON (
    NAME = N'HotSpot_log',
    FILENAME = N'D:\SQLLogs\HotSpot_log.ldf',
    SIZE = 250MB,
    FILEGROWTH = 25MB
);
GO
...
CREATE TABLE HotSpotTable (c1 INT IDENTITY);
CREATE CLUSTERED INDEX HotSpotTable_CL ON HotSpotTable (c1);
GO
