...
WHILE(1 -eq 1)
{
	...
	$srv.ConnectionContext.set_ConnectionString("Data Source=PS-SQL2K12;Initial Catalog=AdventureWorks2012;User Id=aw_webuser;Password=12345;Application Name=AdventureWorks Online Ordering;Workstation ID=AWWEB01");
