/*************************************************
 list all 34 events captured by the default trace 
*************************************************/
...
cross apply (select distinct 
                 eventid
             from fn_trace_geteventinfo (t.id) ) as tei
inner join sys.trace_events as te on tei.eventid = te.trace_event_id
