...
SELECT TOP (1000) te.name AS "EventName",
                  v.subclass_name,
                  t.DatabaseName,
                  t.DatabaseID,
                  t.NTDomainName,
...
WHERE te.category_id = 8 -- Security Audit
      AND (
          ...
          OR te.name IN ( 'Audit Addlogin Event', 'Audit Add DB User Event', 'Audit Add Role Event',
                          'Audit App Role Change Password Event', 'Audit Statement Permission Event',
                          'Audit Schema Object Access Event', 'Audit Database Object Access Event',
                          'Audit Change Audit Event', 'Audit Object Derived Permission Event',
                          'Audit Database Principal Management Event', 'Audit Server Principal Management Event',
