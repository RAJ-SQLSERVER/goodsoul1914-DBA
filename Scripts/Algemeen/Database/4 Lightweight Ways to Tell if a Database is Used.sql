...
EXEC master..sp_whoisactive @show_sleeping_spids = 2,
...
EXEC master..sp_BlitzIndex @DatabaseName = 'AdventureWorks2019', @Mode = 2;
GO
...
SELECT SUBSTRING (
       ...
       CASE
           WHEN pl.query_plan LIKE '%<MissingIndexes>%' THEN 1
           ELSE 0
       END AS "Missing Indexes?",
       qs.execution_count,
