...
BEGIN
    ...
    BEGIN
        ...
        SET @sql = @sql + N'	insert into #tmpStats	select ' + CAST(@dbid AS NVARCHAR(20)) + N' ''Database_Id'''
                   + N',''' + @dbname
...
BEGIN
    ...
    SELECT ag.name AS "ag_name",
           ...
           CASE
               WHEN ar_state.connected_state_desc IS NULL THEN CASE
