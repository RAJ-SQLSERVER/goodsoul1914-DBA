...
IF OBJECT_ID(N'dbo.usp_sizing', 'P') IS NULL
    EXECUTE ('CREATE PROCEDURE usp_sizing AS SELECT 1');
GO

ALTER PROCEDURE dbo.usp_sizing
(
    ...
    BEGIN
        ...
        (
            ...
            (
                ...
                ON T.[database_name] = L.[database_name]
