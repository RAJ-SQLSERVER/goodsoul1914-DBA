...
BEGIN
    ...
    BEGIN
        ...
        (
            ...
            FROM   #errorLog AS b
            WHERE  (
                       b.Text NOT LIKE 'Login succeeded%'
                       AND b.Text NOT LIKE 'Log was backed up%'
                   )
    ...
    BEGIN
        ...
        BEGIN
            ...
            (
                ...
                AvailableSpaceGB DECIMAL(18, 2) NOT NULL
            ) ON [PRIMARY];
        END;
    ...
    BEGIN
        ...
        BEGIN
            ...
            (
                ...
                PhysicalCoreCount INT NOT NULL,
        ...
        SELECT GETDATE(),
               ...
               CASE
                   WHEN @Version >= 15 THEN -- SQL Server 2019 only
                       container_type_desc
                   ELSE
                       'N/A'
               END
    ...
    BEGIN
        ...
        BEGIN
            ...
            (
                ...
                ResourceGovernorTotalReadIOLatencyMs BIGINT NOT NULL,
                ResourceGovernorTotalWriteIOLatencyMs BIGINT NOT NULL
            ) ON [PRIMARY];
        END;
        ...
        (
            ...
            IOStalls,
            TotalIO,
            ResourceGovernorTotalReadIOLatencyMs,
            ResourceGovernorTotalWriteIOLatencyMs
        )
        SELECT     GETDATE(),
    ...
    BEGIN
        ...
        AS (
        SELECT   DB_NAME(DM_IO_STATS.database_id) AS "DatabaseName",
    ...
    BEGIN
        ...
        WHERE  wait_type NOT IN ( N'BROKER_EVENTHANDLER', N'BROKER_RECEIVE_WAITFOR', N'BROKER_TASK_STOP',
                                  ...
                                  N'PARALLEL_REDO_WORKER_WAIT_WORK', N'PREEMPTIVE_HADR_LEASE_MECHANISM',
                                  N'PREEMPTIVE_SP_SERVER_DIAGNOSTICS', N'PREEMPTIVE_OS_LIBRARYOPS',
                                  N'PREEMPTIVE_OS_COMOPS', N'PREEMPTIVE_OS_CRYPTOPS', N'PREEMPTIVE_OS_PIPEOPS',
    ...
    (
        SELECT 1
        FROM   @_Checks
        WHERE  [Check] = 'UDFStatsByDatabase'
    )
               AND NOT EXISTS
    (
        SELECT 1
    ...
    BEGIN
        ...
        BEGIN
            ...
            (
                ...
                AverageElapsedTime BIGINT NOT NULL,
    ...
    BEGIN
        IF OBJECT_ID('dbo.VLFCount') IS NULL
        BEGIN
