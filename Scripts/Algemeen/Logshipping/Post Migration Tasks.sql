...
SELECT @@SERVERNAME AS [Server Name],
	@@VERSION AS [SQL Server Version Information];
...
BACKUP DATABASE AdventureWorksLT2008R2 TO DISK = N'M:\SQLBackups\AdventureWorksLT2008R2FullCompressed.bak'
WITH NOFORMAT,
	INIT,
	NAME = N'AdventureWorksLT2008R2-Full Database Backup',
	SKIP,
	NOREWIND,
	NOUNLOAD,
	COMPRESSION,
...
DBCC CHECKDB (AdventureWorksLT2008R2)
WITH MAXDOP = 4;
GO
