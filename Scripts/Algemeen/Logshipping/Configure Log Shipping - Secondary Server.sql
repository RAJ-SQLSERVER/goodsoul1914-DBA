...
EXEC @LS_Add_RetCode = master.dbo.sp_add_log_shipping_secondary_primary @primary_server = N'LABDB03',
...
BEGIN
	...
	EXEC @LS_Add_RetCode2 = master.dbo.sp_add_log_shipping_secondary_database @secondary_database = N'AdventureWorks',
...
BEGIN
	...
	EXEC msdb.dbo.sp_update_job @job_id = @LS_Secondary__CopyJobId,
		@enabled = 1;

	-- Enable the LS Restore job
	EXEC msdb.dbo.sp_update_job @job_id = @LS_Secondary__RestoreJobId,
		@enabled = 1;
END;
