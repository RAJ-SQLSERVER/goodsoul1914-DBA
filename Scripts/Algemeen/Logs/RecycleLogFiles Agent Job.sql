...
EXECUTE dbo.sp_add_job @job_name = N'RecycleLogFiles',
                       @enabled = 1,
                       @start_step_id = 1,
...
EXECUTE dbo.sp_add_jobserver @job_name = N'RecycleLogFiles',
                             @server_name = N'(LOCAL)';
GO

EXECUTE dbo.sp_add_jobstep @job_name = N'RecycleLogFiles',
...
EXECUTE dbo.sp_add_jobschedule @job_name = N'RecycleLogFiles',
