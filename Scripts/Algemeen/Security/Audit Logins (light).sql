...
/* create table */
CREATE TABLE DBATools.dbo.LoginAudit (LoginName VARCHAR(200), LastLoginDate DATETIME);

/* populate with all logins */
INSERT INTO DBATools.dbo.LoginAudit (LoginName, LastLoginDate)
SELECT name,
       NULL
...
/* update logins */
SELECT MAX (login_time) AS "LoginTime",
