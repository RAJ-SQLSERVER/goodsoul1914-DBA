...
/****** Object:  Job [DYNPERF_PROCESS_TASKS]    Script Date: 9-3-2020 09:26:57 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 9-3-2020 09:26:57 ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [SP_PROCESS_STATS]    Script Date: 9-3-2020 09:26:57 ******/
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'EVERY 5 MINUTES', 
		...
		@schedule_uid=N'2b149405-c3a9-4cbc-bcc8-8fee08d9b86e'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
