...
/****** Object:  Job [DYNPERF_CAPTURE_STATS]    Script Date: 11-5-2020 16:48:38 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [Database Maintenance]    Script Date: 11-5-2020 16:48:38 ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [sp_capturestats]    Script Date: 11-5-2020 16:48:38 ******/
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'5 MINUTES', 
		...
		@schedule_uid=N'f36c571f-ebbb-46bf-bb42-2d92ec6b4a25'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
