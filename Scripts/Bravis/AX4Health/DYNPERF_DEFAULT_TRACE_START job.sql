...
/****** Object:  Job [DYNPERF_DEFAULT_TRACE_START]    Script Date: 9-3-2020 09:26:53 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 9-3-2020 09:26:53 ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Start Tracing]    Script Date: 9-3-2020 09:26:53 ******/
...
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Daily', 
		...
		@schedule_uid=N'610f9d93-e6f0-451a-9881-3f07f4d723f4'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'Startup', 
		...
		@active_start_time=0, 
		@active_end_time=235959, 
		@schedule_uid=N'4a686af6-22bc-49de-817b-41d6ce8b1270'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
