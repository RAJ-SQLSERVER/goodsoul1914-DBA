...
/****** Object:  Job [ZKH: Controle DataWareHouse Bijwerken]    Script Date: 10-2-2020 10:24:09 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]    Script Date: 10-2-2020 10:24:09 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'ZKH: Controle DataWareHouse Bijwerken', 
		@enabled=1, 
		...
		@owner_login_name=N'sysBVSDWHuser', @job_id = @jobId OUTPUT
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Fout Controle DHW Bijwerken]    Script Date: 10-2-2020 10:24:09 ******/
...
IF @tableHTML <> ''''
   BEGIN
    ...
    END', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [HIX Tellingen]    Script Date: 10-2-2020 10:24:09 ******/
...
IF @tableHTML <> ''''
   BEGIN
    ...
    END', 
		...
		@flags=0
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Start Logship]    Script Date: 10-2-2020 10:24:09 ******/
...
-- Start Job
EXEC msdb.dbo.sp_start_job @job_name=''LSRestore_GPHIXSQL02_HIX_PRODUCTIE''

-- Stop Job
EXEC msdb.dbo.sp_stop_job @job_name=''LSRestore_GPHIXSQL02_HIX_PRODUCTIE''
...
IF EXISTS ( SELECT ''Klaar'' WHERE 2 = 
    ...
    BEGIN
             ...
             EXEC msdb.dbo.sp_update_job @job_name = ''LSRestore_GPHIXSQL02_HIX_PRODUCTIE'', @enabled = 1
...
/*            
             SET @RecipientsMail  = ''ma.blom@bravis.nl'' 
             
             SET @tableHTML =  N''<H1>Voor Technisch Applicatiebeheer (TAB)</H1>'' +  
                               N''<H4>LSRestore (Logship bijwerken) op de GPHIXDWH02 is gestart en is weer enabled omdat het bijwerken DWH klaar is.</H4>'' 
*/
      END
...
/*
             ...
             SET @tableHTML =  N''<H1>Voor Technisch Applicatiebeheer (TAB)</H1>'' +  
                               N''<H4>LSRestore (Logship bijwerken) op de GPHIXDWH02 is niet gestart en is gedisabled omdat het bijwerken DWH niet klaar is.</H4>'' 
*/
      END
/*    
IF @tableHTML <> ''''
