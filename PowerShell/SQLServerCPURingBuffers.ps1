...
Get-DbaCpuRingBuffer -SqlInstance $SqlInstances -CollectionMinutes 240 | Write-DbaDataTable -SqlInstance $managementServer -Database $managentDatabase -Table CPURingBuffers -AutoCreateTable
