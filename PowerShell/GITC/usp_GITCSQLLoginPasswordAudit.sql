...
CREATE PROCEDURE [dbo].[usp_GITCSQLLoginPasswordAudit]
AS
BEGIN
    ...
    BEGIN
        ...
        (
			...
			IsDisabled BIT NOT NULL
				DEFAULT(0),
			IsPolicyChecked BIT NOT NULL
				DEFAULT(1),
			IsExpirationChecked BIT NOT NULL
				DEFAULT(1),
    ...
    SELECT @@ServerName ServerName,
		   ...
		   a.is_policy_checked AS IsPolicyChecked,
		   a.is_expiration_checked AS IsExpirationChecked,
    ...
    WHEN MATCHED AND (
						 ...
						 OR a.IsDisabled != b.IsDisabled
						 OR a.IsPolicyChecked != b.IsPolicyChecked
						 OR a.IsExpirationChecked != b.IsExpirationChecked
                     ) THEN
        UPDATE SET a.PwdLastUpdate = b.PwdLastUpdate,
                   a.IsSysAdmin = b.IsSysAdmin,
				   a.IsDisabled = b.IsDisabled,
				   a.IsPolicyChecked = b.IsPolicyChecked,
				   a.IsExpirationChecked = b.IsExpirationChecked
    WHEN NOT MATCHED BY TARGET THEN
        ...
        VALUES
        (b.ServerName, b.SQL_Login, b.IsSysAdmin, b.IsDisabled, b.IsPolicyChecked, b.IsExpirationChecked, b.PwdLastUpdate)
