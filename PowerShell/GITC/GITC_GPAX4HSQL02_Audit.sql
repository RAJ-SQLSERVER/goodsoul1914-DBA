...
CREATE SERVER AUDIT [GITC_GPAX4SQL02_Audit]
    TO FILE (
        FILEPATH = 'D:\SQLAudit',
		MAXSIZE = 1GB
    )
...
CREATE SERVER AUDIT SPECIFICATION [GITC_GPAX4SQL02_AuditSpec]
    FOR SERVER AUDIT [GITC_GPAX4SQL02_Audit]
...
ALTER SERVER AUDIT [GITC_GPAX4SQL02_Audit]
    WITH (
    STATE = ON
);
GO